...
| Fixed trajectory that ignores aim | 35-80 | `trajectory_preview` loses aim-change points; `explosion_gameplay` may still credit localized damage when the blast is otherwise real, nearby, and safe. |
